...
function PlaceSearch(props) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_antd.Select, {
    showSearch: true,
    style: {
      width: '30%'
    },
    ...
    onSelect: /*#__PURE__*/function () {
      var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(address) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 2;
              _context.next = 5;
              return (0, _usePlacesAutocomplete.getGeocode)({
                address: address
              });
            case 5:
    ...
    onSearch: onSearch,
    disabled: !ready,
    children: status === 'OK' && data.map(function (_ref2) {
      var id = _ref2.id,
