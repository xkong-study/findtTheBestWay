...
export default function OtherOption({duration,station,busNumber,arriveTime,walkingTime}){
    console.log(Array(busNumber))
            ...
            <div className="mt-2">
              <div className="flex flex-row justify-between">
                <div className="flex flex-row mt-5">
                  ...
                  <p style={{backgroundColor: "yellow"}}>{walkingTime[0].text.match(regex)}min</p>
                  <ChevronRightIcon className="h-4 w-4" aria-hidden="true"/>
                  <BsBusFrontFill className="w-4 h-4 mx-3"/>
                  <p style={{backgroundColor: "yellow"}}>{busNumber}</p>
                  <ChevronRightIcon className="h-4 w-4" aria-hidden="true"/>
                  <BiWalk className="w-4 h-4 mx-3"/>
                  <p style={{backgroundColor: "yellow"}}>{walkingTime[1]?.text.match(regex)}min</p>
                </div>
